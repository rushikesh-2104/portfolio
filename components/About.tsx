  ...
  return (
    <div className='roboto-condensed w-screen h-[280vh] py-20 px-10 flex justify-center bg-black z-1000 absolute'>
      <div className='text-white'>
        ...
        <Link href="/Aboutme">      
          <div className='relative top-12 left-250 w-[15vw] h-[30vh] rounded-full bg-white text-black flex justify-center items-center text-3xl hover:bg-amber-100'>
            About Me
          </div>
        </Link>
        ...
        <Link href="/Contact">
          <div className='lora relative top-110 left-200 w-[15vw] h-[30vh] rounded-full bg-white text-black flex justify-center items-center text-3xl hover:bg-amber-100'>
            Contact Me
          </div>
        </Link>
        ...
        <div className='h-[5vh] w-[15vw] relative top-80 left-50 text-center p-2 border-white border-1 rounded-full text-white bg-black hover:bg-white hover:text-black'>
          hrishi210402@gmail.com
        </div>

        <div className='h-[5vh] w-[10vw] relative top-70 left-120 text-center p-2 border-white border-1 rounded-full text-white bg-black hover:bg-white hover:text-black'>
          +91 7208553533
        </div>
