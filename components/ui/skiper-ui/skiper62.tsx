...
const Skiper62 = () => {
  ...
  useEffect(() => {
    if (key < greetings.length - 1) {
      const timer = setTimeout(() => setKey((prev) => prev + 1), 500); // slower, smoother
    ...
    <div className="min-h-screen w-screen z-100 bg-black text-white  overflow-x-hidden">
      ...
      {showPortfolio && (
        <div>
          ...
          <span className="absolute z-1000 right-15 bottom-90 text-white text-5xl">Software Developer <br /> & Designer</span>


          <div className="bg-black w-screen flex justify-center ">
            <img src="/rushi.png" alt=""  className="relative h-[100vh] bottom-0" />
          </div>
